export type FeatureCodeInfo = {
  name: string;
  description: string;
};

export const featureCodeInfo: Record<string, FeatureCodeInfo> = {
  'A.ADM1': {
  ...
  'A.ADM5H': {
    name: 'historical fifth-order administrative division',
    description: 'a former fifth-order administrative division',
  },
  'A.ADMD': {
  ...
  'A.ADMS': { name: 'school district', description: 'school district' },
  'A.LTER': {
    name: 'leased area',
    description:
      'a tract of land leased to another country, usually for military installations',
  },
  'A.PCL': { name: 'political entity', description: '' },
  'A.PCLD': { name: 'dependent political entity', description: '' },
  'A.PCLF': { name: 'freely associated state', description: '' },
  'A.PCLH': {
    name: 'historical political entity',
    description: 'a former political entity',
  },
  'A.PCLI': { name: 'independent political entity', description: '' },
  'A.PCLIX': {
    name: 'section of independent political entity',
    description: '',
  },
  'A.PCLS': { name: 'semi-independent political entity', description: '' },
  'A.PRSH': { name: 'parish', description: 'an ecclesiastical district' },
  'A.TERR': { name: 'territory', description: '' },
  'A.ZN': { name: 'zone', description: '' },
  'A.ZNB': {
    name: 'buffer zone',
    description:
  ...
  'H.BNKX': { name: 'section of bank', description: '' },
  'H.BOG': {
    name: 'bog(s)',
    description:
  ...
  'H.CNL': { name: 'canal', description: 'an artificial watercourse' },
  'H.CNLA': { name: 'aqueduct', description: 'a conduit used to carry water' },
  'H.CNLB': {
    name: 'canal bend',
  ...
  'H.FLLSX': { name: 'section of waterfall(s)', description: '' },
  'H.FLTM': {
    name: 'mud flat(s)',
    description:
  ...
  'H.HBRX': { name: 'section of harbor', description: '' },
  'H.INLT': {
    name: 'inlet',
    description:
  ...
  'H.LGNX': { name: 'section of lagoon', description: '' },
  'H.LK': {
    name: 'lake',
  ...
  'H.LKI': { name: 'intermittent lake', description: '' },
  'H.LKN': {
    name: 'salt lake',
    description: 'an inland body of salt water with no outlet',
  },
  'H.LKNI': { name: 'intermittent salt lake', description: '' },
  'H.LKO': {
    name: 'oxbow lake',
    description:
      'a crescent-shaped lake commonly found adjacent to meandering streams',
  },
  'H.LKOI': { name: 'intermittent oxbow lake', description: '' },
  'H.LKS': {
    name: 'lakes',
  ...
  'H.LKSI': { name: 'intermittent lakes', description: '' },
  'H.LKSN': {
    name: 'salt lakes',
    description: 'inland bodies of salt water with no outlet',
  },
  'H.LKSNI': { name: 'intermittent salt lakes', description: '' },
  'H.LKX': { name: 'section of lake', description: '' },
  'H.MFGN': {
  ...
  'H.PND': { name: 'pond', description: 'a small standing waterbody' },
  'H.PNDI': { name: 'intermittent pond', description: '' },
  'H.PNDN': {
    name: 'salt pond',
    description:
      'a small standing body of salt water often in a marsh or swamp, usually along a seacoast',
  },
  'H.PNDNI': { name: 'intermittent salt pond(s)', description: '' },
  'H.PNDS': { name: 'ponds', description: 'small standing waterbodies' },
  'H.PNDSF': {
    name: 'fishponds',
    description: 'ponds or enclosures in which fish are kept or raised',
  },
  'H.PNDSI': { name: 'intermittent ponds', description: '' },
  'H.PNDSN': {
    name: 'salt ponds',
    description:
  ...
  'H.POOLI': { name: 'intermittent pool', description: '' },
  'H.RCH': {
    name: 'reach',
    description:
  ...
  'H.RFX': { name: 'section of reef', description: '' },
  'H.RPDS': {
    name: 'rapids',
    description:
      'a turbulent section of a stream associated with a steep, irregular stream bed',
  },
  'H.RSV': { name: 'reservoir(s)', description: 'an artificial pond or lake' },
  'H.RSVI': { name: 'intermittent reservoir', description: '' },
  'H.RSVT': {
    name: 'water tank',
    description:
  ...
  'H.STMI': { name: 'intermittent stream', description: '' },
  'H.STMIX': { name: 'section of intermittent stream', description: '' },
  'H.STMM': {
    name: 'stream mouth(s)',
    description:
  ...
  'H.STMX': { name: 'section of stream', description: '' },
  'H.STRT': {
    name: 'strait',
    description:
  ...
  'H.WADX': { name: 'section of wadi', description: '' },
  'H.WHRL': {
    name: 'whirlpool',
  ...
  'H.WLLQ': { name: 'abandoned well', description: '' },
  'H.WLLS': {
    name: 'wells',
    description:
  ...
  'H.WTLDI': { name: 'intermittent wetland', description: '' },
  'H.WTRC': {
    name: 'watercourse',
    description:
  ...
  'L.GVL': { name: 'gravel area', description: 'an area covered with gravel' },
  'L.INDS': {
  ...
  'P.PPLA5': {
    name: 'seat of a fifth-order administrative division',
    description: '',
  },
  'P.PPLC': {
    name: 'capital of a political entity',
    description:
      'capital of a political entity designated as an independent state',
  },
  'P.PPLCD': {
    name: 'capital of a dependency or special area',
    description:
      'capital or administrative center of a dependent political territory or area of special sovereignty',
  },
  'P.PPLCH': {
  ...
  'P.PPLQ': { name: 'abandoned populated place', description: '' },
  'P.PPLR': {
  ...
  'P.PPLX': { name: 'section of populated place', description: '' },
  'P.STLMT': { name: 'israeli settlement', description: '' },
  'R.CSWY': {
    name: 'causeway',
  ...
  'R.RRQ': { name: 'abandoned railroad', description: '' },
  'R.RTE': {
    name: 'caravan route',
  ...
  'R.ST': { name: 'street', description: 'a paved urban thoroughfare' },
  'R.STKR': {
    name: 'stock route',
  ...
  'S.AIRQ': { name: 'abandoned airfield', description: '' },
  'S.AIRT': {
    name: 'terminal',
    description:
  ...
  'S.ANS': {
    name: 'archaeological/prehistoric site',
    description:
  ...
  'S.ARCHV': {
    name: 'archive',
    description: 'a place or institution where documents are preserved',
  },
  'S.ART': {
    name: 'piece of art',
    description:
  ...
  'S.CMPL': { name: 'logging camp', description: 'a camp used by loggers' },
  'S.CMPLA': {
    name: 'labor camp',
    description: 'a camp used by migrant or temporary laborers',
  },
  'S.CMPMN': { name: 'mining camp', description: 'a camp used by miners' },
  'S.CMPO': {
    name: 'oil camp',
    description: 'a camp used by oilfield workers',
  },
  'S.CMPQ': { name: 'abandoned camp', description: '' },
  'S.CMPRF': { name: 'refugee camp', description: 'a camp used by refugees' },
  'S.CMTY': { name: 'cemetery', description: 'a burial place or ground' },
  'S.COMC': {
  ...
  'S.CTYD': {
    name: 'courtyard',
    description:
      'an area surrounded by a building or complex and open to the sky',
  },
  'S.CVNT': {
    name: 'convent',
  ...
  'S.DPOF': { name: 'fuel depot', description: 'an area where fuel is stored' },
  'S.EST': {
    name: 'estate(s)',
    description:
  ...
  'S.ESTX': { name: 'section of estate', description: '' },
  'S.FCL': {
    name: 'facility',
    description:
  ...
  'S.FRMQ': { name: 'abandoned farm', description: '' },
  'S.FRMS': {
    name: 'farms',
    description:
  ...
  'S.FT': { name: 'fort', description: 'a defensive structure or earthworks' },
  'S.FY': {
    name: 'ferry',
    description:
  ...
  'S.GRVE': { name: 'grave', description: 'a burial site' },
  'S.HERM': {
    name: 'hermitage',
  ...
  'S.HUT': { name: 'hut', description: 'a small primitive house' },
  'S.HUTS': { name: 'huts', description: 'small primitive houses' },
  'S.INSM': {
  ...
  'S.MFGQ': { name: 'abandoned factory', description: '' },
  'S.MFGSG': {
    name: 'sugar refinery',
  ...
  'S.MNQ': { name: 'abandoned mine', description: '' },
  'S.MNQR': {
    name: 'quarry(-ies)',
    description:
  ...
  'S.MSSNQ': { name: 'abandoned mission', description: '' },
  'S.MSTY': {
    name: 'monastery',
    description:
  ...
  'S.OILQ': { name: 'abandoned oil well', description: '' },
  'S.OILR': {
    name: 'oil refinery',
    description:
  ...
  'S.PPQ': { name: 'abandoned police post', description: '' },
  'S.PRKGT': {
    name: 'park gate',
  ...
  'S.PRNQ': { name: 'abandoned prison', description: '' },
  'S.PS': {
    name: 'power station',
  ...
  'S.RECR': { name: 'racetrack', description: 'a track where races are held' },
  'S.REST': {
    name: 'restaurant',
  ...
  'S.RSTNQ': { name: 'abandoned railroad station', description: '' },
  'S.RSTP': {
    name: 'railroad stop',
    description:
      'a place lacking station facilities where trains stop to pick up and unload passengers and freight',
  },
  'S.RSTPQ': { name: 'abandoned railroad stop', description: '' },
  'S.RUIN': {
    name: 'ruin(s)',
    description:
  ...
  'S.THTR': {
    name: 'theater',
    description:
      'a building or outdoor area used for live theatrical presentations, concerts, opera or dance productions, cinema, and/or other stage productions',
  },
  'S.TMB': { name: 'tomb(s)', description: 'a structure for interring bodies' },
  'S.TMPL': {
    name: 'temple(s)',
  ...
  'S.TWO': { name: 'temp work office', description: 'Temporary Work Offices' },
  'S.UNIP': {
  ...
  'T.ISLX': { name: 'section of island', description: '' },
  'T.ISTH': {
    name: 'isthmus',
    description:
  ...
  'T.LAVA': { name: 'lava area', description: 'an area of solidified lava' },
  'T.LEV': {
    name: 'levee',
    description:
  ...
  'T.MND': { name: 'mound(s)', description: 'a low, isolated, rounded hill' },
  'T.MRN': {
    name: 'moraine',
  ...
  'T.PENX': { name: 'section of peninsula', description: '' },
  'T.PK': {
    name: 'peak',
    description:
  ...
  'T.PLATX': { name: 'section of plateau', description: '' },
  'T.PLDR': {
    name: 'polder',
  ...
  'T.PLNX': { name: 'section of plain', description: '' },
  'T.PROM': {
    name: 'promontory(-ies)',
    description:
  ...
  'T.RK': { name: 'rock', description: 'a conspicuous, isolated rocky mass' },
  'T.RKFL': {
    name: 'rockfall',
    description:
      'an irregular mass of fallen rock at the base of a cliff or steep slope',
  },
  'T.RKS': { name: 'rocks', description: 'conspicuous, isolated rocky masses' },
  'T.SAND': {
    name: 'sand area',
  ...
  'T.VALX': { name: 'section of valley', description: '' },
  'T.VLC': {
    name: 'volcano',
    description:
  ...
  'U.FLTU': { name: 'flat', description: 'a small level or nearly level area' },
  'U.FRZU': {
    name: 'fracture zone',
    description:
  ...
  'U.GAPU': { name: 'gap', description: 'a narrow break in a ridge or rise' },
  'U.GLYU': { name: 'gully', description: 'a small valley-like feature' },
  'U.HLLU': {
    name: 'hill',
  ...
  'U.MNDU': { name: 'mound', description: 'a low, isolated, rounded hill' },
  'U.MOTU': {
    name: 'moat',
    description:
  ...
  'V.GRVO': { name: 'olive grove', description: 'a planting of olive trees' },
  'V.GRVP': { name: 'palm grove', description: 'a planting of palm trees' },
  'V.GRVPN': { name: 'pine grove', description: 'a planting of pine trees' },
  'V.HTH': {
    name: 'heath',
    description:
  ...
  'V.VIN': { name: 'vineyard', description: 'a planting of grapevines' },
  'V.VINS': { name: 'vineyards', description: 'plantings of grapevines' },
};

export function getFeatureCodeInfo(featureClass: string, featureCode: string) {
  return (
    featureCodeInfo[`${featureClass}.${featureCode}`] ??
    featureCodeInfo[featureCode]
  );
}
